(function(window){
	var Zhilongmicheng = function(option){
		if(arguments[0] === undefined) return false;
		this.data = typeof(arguments[0]) == 'object' ? arguments[0] : {};
		this.o = {platform:"web",url:"images/zhilongmicheng/"};
		if(this.o.platform == "android"){
			this.o.url="../images/zhilongmicheng/";
		}
		this.init();
	};
	
	Zhilongmicheng.prototype = {
	...
	window.Zhilongmicheng = Zhilongmicheng;
})(window);

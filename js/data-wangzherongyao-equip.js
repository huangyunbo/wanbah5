(function(window){
	...
	WzryEquip.prototype = {
		htmlDetail: function(){//详情页
			var that = this,
				t_index = Number(that.getsession("wbgl-wangzherongyao-equip-tindex")),//类别数组下标
				id = Number(that.getsession("wbgl-wangzherongyao-equip-id")),//装备id
				piece,
				html_equipd_head = '',
			...
			$("#equipd_need_ul").on("click", "li", function(){//点击合成所需跳转
				...
				that.setsession("wbgl-wangzherongyao-equip-id", _id);
				
				if(that.o.platform == "ios"){
					location.href = that.o.plugin+'/data-wangzherongyao-equip-detail.html';
				}else{
					location.href = 'data-wangzherongyao-equip-detail.html';
				}
			});
			...
			$("#equipd_fithero").on("click", "li", function(){//适合英雄跳转
				...
				if(that.o.platform == "ios"){
					that.setsession("wbgl-wangzherongyao-equip2hero", "y");//保证跳转到英雄详情页，然后再跳回来
					location.href = that.o.plugin_hero+'/data-wangzherongyao-hero-detail.html';
		...
		htmlIndex: function(){//列表页
			var html_equip_head = '',
				...
				piece,
				t_index = Number(that.getsession("wbgl-wangzherongyao-equip-tindex"));
			...
			$("#equip_content").on("click", "li", function(){
				...
				that.setsession("wbgl-wangzherongyao-equip-tindex", t_index);
				that.setsession("wbgl-wangzherongyao-equip-id", _id);

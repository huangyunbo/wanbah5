(function(window){
	var Huoyingrenzhe = function(option){
		if(arguments[0] === undefined) return false;
		this.data = typeof(arguments[0]) == 'object' ? arguments[0] : {};
		this.o = {platform:"web",url:"images/huoyingrenzhe/"};
		if(this.o.platform == "android"){
			this.o.url="../images/huoyingrenzhe/";
		}
		this.init();
	};
	
	Huoyingrenzhe.prototype = {
	...
	window.Huoyingrenzhe = Huoyingrenzhe;
})(window);
